        ...
        <div className="contact__container container grid">
            ...
            <div className="contact__info">
                <div className="contact__card">
                    ...
                    <a href="mailto:kiruthigaakumar@gmail.com" className="contact__button">Write me{" "}
                    ...
                    <a href="https://api.whatsapp.com/send?phone=8838104578&text=Hello, more information!
" className="contact__button">Write me{" "}
                  ...
                  <div className="contact__card">
                    ...
                    <a href="https://m.me/kiruthigaakumar" className="contact__button">Write me{" "}
                     <i className="bx bx-right-arrow-alt contact__button-icon"></i>
                     </a>
                  </div>  
                </div>
            ...
            <div className="contact__content">
                <h3 className="contact__title">Wanna work together?write me your project</h3>
