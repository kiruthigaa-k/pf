...
const Data = () => {
  return (
     <div className="home__data">
        <h1 className="home__title">Kiruthigaa .K
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <h3 className="home__subtitle">Computer Science and Design
student at RMK Engineering
college</h3>
<p className="home__description">An enthusiastic fresher
eager to learn new technologies
and aspiring web developer.</p>
